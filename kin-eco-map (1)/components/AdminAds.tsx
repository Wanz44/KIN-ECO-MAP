...
import { ArrowLeft, Plus, Megaphone, TrendingUp, Eye, MousePointer, Calendar, DollarSign, PauseCircle, PlayCircle, Trash2, BarChart3, Filter, ListFilter, Upload, Building2, Mail, Phone, MoreVertical, Edit2, User, X, Check, Image as ImageIcon } from 'lucide-react';
...
const MOCK_ADS: AdCampaign[] = [
    {
        id: '1',
        title: 'Campagne Tri Sélectif',
        partner: 'Hôtel de Ville Kinshasa',
        status: 'active',
        views: 12500,
        clicks: 450,
        budget: 5000,
    ...
    {
        id: '3',
        title: 'Recyclage Bouteilles',
        partner: 'Coca-Cola RDC',
        status: 'paused',
        views: 45000,
        clicks: 1200,
        budget: 10000,
...
const MOCK_PARTNERS: Partner[] = [
    {
        id: '1',
        name: 'Hôtel de Ville Kinshasa',
        industry: 'Gouvernement',
        contactName: 'Jean Kabeya',
        email: 'partenariat@kinshasa.cd',
        phone: '+243 81 234 5678',
        activeCampaigns: 1,
        totalBudget: 15000,
        logo: 'https://ui-avatars.com/api/?name=H+V&background=0D8ABC&color=fff',
        status: 'active'
    },
    {
        id: '2',
        ...
        email: 'marketing@marsavco.cd',
        phone: '+243 99 876 5432',
        activeCampaigns: 1,
        totalBudget: 8500,
        logo: 'https://ui-avatars.com/api/?name=Ma&background=FF5252&color=fff',
        status: 'active'
    },
    {
        id: '3',
        name: 'Coca-Cola RDC',
        industry: 'Boissons',
        contactName: 'Patrick Mbemba',
        email: 'pmbemba@cocacola.com',
        phone: '+243 82 000 0000',
        activeCampaigns: 0,
        totalBudget: 50000,
        logo: 'https://ui-avatars.com/api/?name=C+C&background=F44336&color=fff',
        status: 'active'
    }
];
...
export const AdminAds: React.FC<AdminAdsProps> = ({ onBack, onToast }) => {
    ...
    const handleSaveCampaign = (e: React.FormEvent) => {
        ...
        const campaign: AdCampaign = {
            ...
            image: newCampaign.image || 'https://picsum.photos/400/200'
        };
        setAds([campaign, ...ads]);
    ...
    const filteredAds = ads
        ...
        .filter(ad => {
            ...
            // Note: In a real app, date parsing would be more robust. 
            // Here we skip strict comparison for simplicity of the mock date inputs vs string formats.
            return true;
        })
        .sort((a, b) => {
            // Mock sort
                    ...
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm">
                                ...
                                <h3 className="text-2xl font-bold text-gray-800 dark:text-white">$14,500</h3>
                            ...
                            <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm">
                                <div className="flex justify-between items-start mb-2">
                                    ...
                                    <span className="text-xs font-bold text-green-500 flex items-center gap-1">+5% <TrendingUp size={12} /></span>
                                </div>
                                <h3 className="text-2xl font-bold text-gray-800 dark:text-white">65.9K</h3>
                        ...
                        {/* Filters & Sorting */}
                        <div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm">
                            <div className="flex w-full md:w-auto p-1 bg-gray-100 dark:bg-gray-700 rounded-xl overflow-x-auto no-scrollbar">
                                {[
                                    { id: 'all', label: 'Tous' },
                            ...
                            <div className="flex items-center gap-3 w-full md:w-auto">
                                ...
                                <select 
                                    ...
                                    className="flex-1 md:flex-none bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-800 dark:text-white text-sm rounded-xl px-3 py-2 outline-none focus:ring-2 focus:ring-[#2962FF]"
                                >
                                    <option value="startDate">Date de début (Récent)</option>
                                    <option value="endDate">Date de fin (Proche)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            <div className="flex-1 bg-white dark:bg-gray-800 p-3 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-center gap-3">
                                <div className="p-2 bg-gray-100 dark:bg-gray-700 rounded-lg text-gray-500">
                                    <Calendar size={18} />
                                </div>
                                <div className="flex-1">
                                    <label className="text-[10px] font-bold text-gray-400 uppercase block mb-1">A partir du</label>
                                    <input 
                                        type="date" 
                                        value={dateStart}
                                        onChange={(e) => setDateStart(e.target.value)}
                                        className="w-full bg-transparent text-sm font-semibold text-gray-800 dark:text-white outline-none"
                                    />
                                </div>
                                {dateStart && (
                                    <button onClick={() => setDateStart('')} className="p-1 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full">
                            ...
                            <div className="flex-1 bg-white dark:bg-gray-800 p-3 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                    <label className="text-[10px] font-bold text-gray-400 uppercase block mb-1">Jusqu'au</label>
                                    <input 
                                        type="date" 
                                        value={dateEnd}
                                ...
                                {dateEnd && (
                                    <button onClick={() => setDateEnd('')} className="p-1 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full">
                                        <X size={14} className="text-gray-400"/>
                                    </button>
                                )}
                            </div>
                                ...
                                <div key={partner.id} className="bg-white dark:bg-gray-800 rounded-2xl p-5 border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-all flex flex-col">
                                    <div className="flex justify-between items-start mb-4">
                                        <div className="flex gap-4">
                                            <div className="w-14 h-14 rounded-xl bg-gray-50 dark:bg-gray-700 overflow-hidden flex items-center justify-center border border-gray-100 dark:border-gray-600">
